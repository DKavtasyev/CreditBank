...
{
	@Before("ru.neostudy.neoflex.calculator.aspect.Pointcuts.allControllerMethods()")
	...
	@AfterReturning(pointcut = "ru.neostudy.neoflex.calculator.aspect.Pointcuts.calculatorServicePreScoreMethod()",
			returning = "offerList")
	...
	@AfterReturning(pointcut = "ru.neostudy.neoflex.calculator.aspect.Pointcuts.calculatorServiceScoreMethod()",
			returning = "credit")
