...
/**
 * Калькулятор кредита с фиксированной процентной ставкой, с начислением процентов каждый день, с аннуитетным
 * ежемесячным платежом, со страховкой 5 % от суммы кредита при сниженной ставке на 3 %
 */
@Log4j2
@RestController
