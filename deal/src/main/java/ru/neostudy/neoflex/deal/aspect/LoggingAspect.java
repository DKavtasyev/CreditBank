...
public class LoggingAspect
{
	...
	@Around("ru.neostudy.neoflex.deal.aspect.Pointcuts.allControllerMethods()")
	...
	@AfterReturning(pointcut = "execution(* ru.neostudy.neoflex.deal.service.ClientEntityService.findClientByPassport(..))", returning = "optionalClient")
	...
	@AfterThrowing(pointcut = "execution(* ru.neostudy.neoflex.deal.service.ClientEntityService.checkAndSaveClient(..))", throwing = "exception")
	...
	@AfterReturning(pointcut = "execution(* ru.neostudy.neoflex.deal.service.DataService.writeData(..))", returning = "statement")
	...
	@After("execution(* ru.neostudy.neoflex.deal.service.DataService.updateStatement(..))")
	...
	@After("execution(* ru.neostudy.neoflex.deal.service.StatementEntityService.setStatus(..))")
	...
	@Around("ru.neostudy.neoflex.deal.aspect.Pointcuts.allCalculatorRequesterMethods()")
	...
	@After("ru.neostudy.neoflex.deal.aspect.Pointcuts.allSaveEntityMethods()")
	...
	@After("execution(* ru.neostudy.neoflex.deal.service.ScoringService.scoreAndSaveCredit(..))")
